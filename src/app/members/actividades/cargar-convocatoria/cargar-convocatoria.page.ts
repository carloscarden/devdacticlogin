...
export class CargarConvocatoriaPage implements OnInit {
  ...
  onSubmit() {
    ...
    const inicio = this.convocatoria.inicio.split('-');
    ...
    console.log('this.convocatoria', this.convocatoria);
  ...
  validarFechaInicio() {
    ...
    let diaDeLaSemana = dias[diaDeHoy.getUTCDay()];
    let inicioDeLaSemana;
    let diaPosible;

    diaPosible = this.convocatoria.inicio.split('-');
